...
for v in PODCAST_PUBLIC_URL PODCAST_HTTP_PORT PODCAST_INBOX PODCAST_DATA_DIR \
         ...
         PODCAST_FEED_AUTHOR PODCAST_FEED_WEBSITE PODCAST_COVER_KEY \
         PODCAST_VOICE PODCAST_SCRIPT_MODEL PODCAST_GROUPING_MODEL \
         PODCAST_B2_KEY_ID PODCAST_B2_APP_KEY PODCAST_B2_BUCKET PODCAST_B2_PREFIX; do
  val="${!v:-}"
  if [ -n "$val" ]; then
